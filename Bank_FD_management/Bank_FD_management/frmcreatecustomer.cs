        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (chbNewData.Checked)
                {
                    ...
                    {
                        OleDbCommand cmd = new OleDbCommand("insert into customer_master (C_name , address , city , state , district , pin_code , phone , e_mail , DOB  , PAN , Add_date , is_minor_cust , g_name , g_addr , g_relation , g_phone )values('" + txtname.Text + "', '" + txtaddress.Text + "', '" + cmbcity.Text + "', '" + cmbstate.Text + "', '" + cmbdistrict.Text + "', " + txtPinCode.Text + ", " + txtPhone.Text + ",'" + txtemail.Text + "', #" + dtpcustbirth.Value.ToString("yyyy-MM-dd HH:mm:ss") + "# ,'" + txtpan.Text + "', #" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "#, " + chbminor.Checked + ", '" + txtgname.Text + "', '" + txtgaddress.Text + "', '" + txtgrelation.Text + "', '" + txtGuardPhone.Text + "')", Program.conn);
                        cmd.ExecuteNonQuery();
                    ...
                    {
                        OleDbCommand cmd = new OleDbCommand("insert into customer_master (C_name , address , city , state , district , pin_code , phone , e_mail , DOB  , PAN , Add_date, have_nom,  N_name , Rel_of_nom , Phone_nom , Is_minor , dob_nom, Age_minor) values('" + txtname.Text + "', '" + txtaddress.Text + "', '" + cmbcity.Text + "', '" + cmbstate.Text + "', '" + cmbdistrict.Text + "', " + txtPinCode.Text + ", " + txtPhone.Text + ",'" + txtemail.Text + "', #" + dtpcustbirth.Value.ToString("yyyy-MM-dd HH:mm:ss") + "# ,'" + txtpan.Text + "', #" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "#, " + chbnominee.Checked + ", '" + txtnname.Text + "', '" + txtnrelation.Text + "', '" + txtNomPhone.Text + "', " + chbisnomminor.Checked + ", #" + dobNom.Value.ToString("yyyy-MM-dd HH:mm:ss") + "#, " + (DateTime.Now.Year - dobNom.Value.Year) + ")", Program.conn);
                        cmd.ExecuteNonQuery();
                    ...
                    {
                        OleDbCommand cmd = new OleDbCommand("insert into customer_master (C_name , address , city , state , district , pin_code , phone , e_mail , DOB  , PAN , Add_date) values('" + txtname.Text + "', '" + txtaddress.Text + "', '" + cmbcity.Text + "', '" + cmbstate.Text + "', '" + cmbdistrict.Text + "', " + txtPinCode.Text + ", " + txtPhone.Text + ",'" + txtemail.Text + "', #" + dtpcustbirth.Value.ToString("yyyy-MM-dd HH:mm:ss") + "# ,'" + txtpan.Text + "', #" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "#)", Program.conn);
                        cmd.ExecuteNonQuery();
